...
class UpgradeMemory:
    def __init__(self, db_path: Path):
        ...
        self.conn=connect_sqlite(self.db_path); self.conn.row_factory=sqlite3.Row
    ...
    def effectiveness(self, change_type: Optional[str]=None, target: Optional[str]=None) -> dict:
        clauses=[]; params=[]
