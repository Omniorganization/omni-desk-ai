...
class DailySelfLearningJob:
    ...
    def _run_controlled_self_learning(self, *, days: int) -> dict[str, Any]:
        ...
        for proposal in proposals:
            ...
            validation_commands = None if proposal.proposal_type in {"code_fix", "test_improvement"} else []
            validation = self.sandbox_validator.validate(proposal, commands=validation_commands)
            ...
            if decision.allowed and decision.requires_pr:
                if validation.ok:
                    ...
                    validation_blocked_pr_drafts.append({
        ...
        report = ControlledLearningReport(
            ...
            phase_3={
                ...
                "pr_drafts": pr_drafts,
                "validation_blocked_pr_drafts": validation_blocked_pr_drafts,
