...
class ChannelHttpClient:
    ...
    async def post(self, url: str, *, headers: Optional[dict[str, str]] = None, params: Optional[dict[str, Any]] = None, json: Any = None) -> ChannelHttpResult:
    ...
    async def request(self, method: str, url: str, *, headers: Optional[dict[str, str]] = None, params: Optional[dict[str, Any]] = None, json: Any = None) -> ChannelHttpResult:
        lib = _require_httpx()
