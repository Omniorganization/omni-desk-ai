...
Before promoting a runner, use strict mode to exercise rejection paths for unsafe archives, symlinks, blocked commands, nonce replay, and oversized archives:
