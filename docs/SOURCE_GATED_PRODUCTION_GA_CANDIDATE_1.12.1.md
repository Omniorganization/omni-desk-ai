# OmniDesk 1.12.1 Root Monorepo Production GA Candidate

This version is intentionally named `1.12.1+root-monorepo-production-ga-candidate`. It upgrades the 1.11.8 enterprise chat candidate toward the requested production-GA-candidate shape without claiming customer-distribution GA.
