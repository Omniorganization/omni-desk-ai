...
- `omnidesk_agent/core/models.py` no longer uses Python 3.10-only `@dataclass(slots=True)` or explicit slot definitions that conflict with dataclass defaults under Python 3.9.
