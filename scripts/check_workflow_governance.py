...
REQUIRED_SNIPPETS = [
    ...
    "real-ga-evidence-audit-1.12.3.json",
...
def check(root: Path, *, require_real_workflows: bool = False) -> list[str]:
    ...
    fallback_paths = [root / "patches" / "v1.12.3-apply.patch", root / "Makefile"]
    ...
    if not text:
        issues.append("no workflow, Makefile, or v1.12.3 patch content found for governance validation")
        return issues
