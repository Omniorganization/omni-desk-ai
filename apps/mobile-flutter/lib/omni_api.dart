...
class OmniApiClient {
  ...
  Future<Map<String, String>> _headers(String method, String path, String body,
  ...
  Future<Map<String, dynamic>> registerMobile(
          {required String deviceId, String? pushToken, String? publicKey}) =>
      _request(
          'POST',
  ...
  Future<Map<String, dynamic>> sendMessage(
      ...
      _request(
          ...
          idempotencyKey ??
              'mobile-message-$conversationId-${content.hashCode}');

  Future<Map<String, dynamic>> decideApproval(
          String approvalId, String decision,
          {String? reason, String? sourceDeviceId, String? idempotencyKey}) =>
      _request(
          'POST',
  ...
  Future<Map<String, dynamic>> registerPushToken(
          String deviceId, String pushToken, {String platform = 'flutter'}) =>
      _request('POST', '/app/devices/$deviceId/push-token',
          <String, dynamic>{'push_token': pushToken, 'platform': platform});
