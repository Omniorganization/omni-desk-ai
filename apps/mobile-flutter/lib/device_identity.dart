...
class DeviceIdentityStore {
  ...
  Future<OmniDeviceIdentity> loadOrCreate() async {
    ...
    if (existingId != null &&
      ...
      return OmniDeviceIdentity(
          deviceId: existingId, publicKey: existingPublicKey);
    }
  ...
  Future<Map<String, String>> signRequest(
      {required String method, required String path, String body = ''}) async {
    ...
    final algorithm = Ed25519();
    final keyPair =
        await algorithm.newKeyPairFromSeed(base64Decode(privateKeyEncoded));
    final signature =
