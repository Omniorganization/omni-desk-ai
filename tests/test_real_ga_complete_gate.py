...
def _team_contract(root: Path, *, owner_type: str = "User") -> None:
    _write_json(
        root / ".github" / "team-governance.required.json",
        {
            ...
            "required_teams": [
                {"slug": "omnidesk-maintainers", "minimum_repository_permission": "maintain", "required_paths": ["*"]},
                {"slug": "release-owners", "minimum_repository_permission": "push", "required_paths": [".github/workflows/", "scripts/", "release/", "omnidesk_agent/self_upgrade/"]},
                {"slug": "security-owners", "minimum_repository_permission": "push", "required_paths": [".github/workflows/", "release/", "omnidesk_agent/security/", "omnidesk_agent/sandbox/", "omnidesk_agent/plugins/", "omnidesk_agent/self_upgrade/"]},
                {"slug": "platform-owners", "minimum_repository_permission": "push", "required_paths": ["deploy/", "omnidesk_agent/sandbox/"]},
            ],
