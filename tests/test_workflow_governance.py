...
def test_workflow_governance_accepts_patch_contract(tmp_path, capsys) -> None:
    patch = tmp_path / "patches" / "v1.12.6-apply.patch"
...
python scripts/import_ios_real_device_evidence.py --write-report release/real-ga-evidence-audit-1.12.6.json
...
steps:
  ...
  - run: python scripts/import_ios_real_device_evidence.py --write-report release/real-ga-evidence-audit-1.12.6.json
