...
def test_workflow_governance_accepts_patch_contract(tmp_path, capsys) -> None:
    patch = tmp_path / "patches" / "v1.12.4-apply.patch"
...
python scripts/import_ios_real_device_evidence.py --write-report release/real-ga-evidence-audit-1.12.4.json
...
steps:
  ...
  - run: python scripts/import_ios_real_device_evidence.py --write-report release/real-ga-evidence-audit-1.12.4.json
  ...
  - uses: actions/upload-artifact
    with:
      path: |
        dist/
        release/real-ga-evidence-audit-1.12.4.json
        release/ios-real-device-evidence-import-report.json
        release/tri-app-live-smoke-evidence-import-report.json
